...
> 자산 · 스캔 · 발견 · 승인 · 감사까지 한 흐름에서. 분석은 AI가, 결정은 사람이.
...
### 2. 권한 요청 흐름 끊김 → Self-service Access Center
...
### 3. 한국 규제 매핑 부재 → Regulations Guide + 정책 템플릿
...
### 4. AI 도입 장벽 → Provider 추상화 + 폐쇄망 옵션
...
- 🛠️ 설치하기 → [docs/SETUP.md](SETUP.md) — Helm / Docker / AI / 로그인 / 관리자 초기 세팅
